      ...
      <div className={styles.container}>
        ...
        <div className={styles.inner}>
          ...
          <p className={styles.sub}>
            I'm currently available for AI integration projects, technical consulting,
            and fullstack development work. Reach out and let's talk.
          </p>
          ...
          <div className={styles.links}>
            ...
            <a href="https://www.linkedin.com/in/gabriela-rubio-06111911/" target="_blank" rel="noreferrer" className={styles.link}>
              <div className={styles.linkIcon}>
            ...
            <a href="https://github.com/MaGabyZR" target="_blank" rel="noreferrer" className={styles.link}>
              <div className={styles.linkIcon}>
            ...
            <a href="tel:+50258431715" className={styles.link}>
              ...
              <div>
                ...
                <span className={styles.linkVal}>+502 5843-1715</span>
              </div>
            </a>
          </div>
        </div>
